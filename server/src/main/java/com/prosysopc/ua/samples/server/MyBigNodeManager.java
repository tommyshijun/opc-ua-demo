...
public class MyBigNodeManager extends NodeManager {
  ...
  public class MyReference extends UaReference {
     ...
     * (non-Javadoc)
     *
     * @see com.prosysopc.ua.nodes.UaReference#getIsInverse(org.opcfoundation
     ...
     * (non-Javadoc)
     *
     * @see com.prosysopc.ua.nodes.UaReference#getIsInverse(com.prosysopc.ua. nodes.UaNode)
     */
    @Override
   ...
   *         address space.
   * @throws StatusException if the NodeId is invalid (i.e. null)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getVariableDataType(org.opcfoundation
   * .ua.builtintypes.NodeId)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#hasNode(org.opcfoundation.ua. builtintypes .NodeId)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#afterCreateMonitoredDataItem(com.
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#deleteMonitoredItem(com.prosysopc
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getBrowseName(org.opcfoundation.ua
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getDisplayName(org.opcfoundation.
   * ua.builtintypes.ExpandedNodeId, com.prosysopc.ua.nodes.UaNode, java.util.Locale)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getNodeClass(org.opcfoundation.ua
   * .builtintypes.ExpandedNodeId, com.prosysopc.ua.nodes.UaNode)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getReferences(org.opcfoundation.ua
   ...
   * (non-Javadoc)
   *
   * @see com.prosysopc.ua.server.NodeManager#getTypeDefinition(org.opcfoundation
